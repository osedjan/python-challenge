...
# Join File Path
filepath = os.path.join( cwkdir,"PyPoll/election_data.csv")
...
line5 = str(f"Khan: {str(kcount)}")
line6 = str(f"Correy: {str(ccount)}")
line7 = str(f"Li: {str(lcount)}")
line8 = str(f"O'Tooley: {str(ocount)}")
line9 = "--------------------------"
line10 = str(f"Winner: {winner}")
line11 = "--------------------------"
output.write('{}\n{}\n{}\n{}\n{}\n{}\n{}\n'.format(line5, line6, line7, line8, line9, line10, line11))